...
public class T09_SetTest {
	public static void main(String[] args) {
		...
		// Set은 데잉터의 순서가 없고, 중복을 허용하지 않는다.
		// 그래서 이미 있는 데이터를 add하면 false를 반환하고, 데잉터는 추가되지 않는다.
		...
		isAdd = hs1.add("CC");
		System.out.println("중복되 때 : " + isAdd);
		System.out.println("Set 데이터 : " + hs1);
		System.out.println();
		...
		Iterator it = hs1.iterator();	// Iterator도 원래 제네릭 타입인데 우리는 NonGeneric으로 그냥 Object로 쓰고있어서 안씀.
		// 데이터 개수만큼 반복하기
		...
		// Collection유형의 객체들(List, Set)은 서로다른 자료구조로 쉽게 변경해서 사용할 수 있다.
