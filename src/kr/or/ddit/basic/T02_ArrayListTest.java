...
public class T02_ArrayListTest {
	...
	public static void main(String[] args) {
		...
		// DEFAULT_CAPACITY = 10;
		ArrayList list1 = new ArrayList();	// List list = new Vector<>(); 해도 상관없다.
		...
		// 삭제하기도 같다.
		list1.remove(0);	// return이 객체
		System.out.println("삭제후 : " + list1);
		
		list1.remove("bbb");	// return이 true / false
		...
		String[] strArr2 = list2.toArray(new String[0]);	// 헷갈리니깐 좀 봐두자.
		...
		*/
		...
		// 삭제된 결과 
		System.out.println("첫번쨰 : " + list2.size());
		for(int i=0; i< list2.size(); i++) {
			list2.remove(i);
		}
		System.out.println("두번째 : " + list2.size());
